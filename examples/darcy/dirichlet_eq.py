...
Dirichlet boundary conditions are applied by equilibrium conditions.
"""
import argparse
import numpy as np
...
from src.darcy import AdvectionDiffusionReactionBGK, ADR_EquilibriumBC
...
class DirichletDarcy(AdvectionDiffusionReactionBGK):
    ...
    def set_boundary_conditions(self):
        ...
        # apply equilibrium boundary condition to the walls
        self.BCs.append(ADR_EquilibriumBC(tuple(walls.T), self.gridInfo, self.precisionPolicy, rho=0))
...
if __name__ == "__main__":
    ...
    output_dir = os.path.abspath("./results/darcy/dirichlet_eq")

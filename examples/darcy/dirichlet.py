...
from src.darcy import AdvectionDiffusionReactionBGK, ADR_AntiBounceBack
...
class DirichletDarcy(AdvectionDiffusionReactionBGK):
    ...
    def set_boundary_conditions(self):
        ...
        self.BCs.append(ADR_AntiBounceBack(tuple(walls.T), self.gridInfo, self.precisionPolicy))
...
if __name__ == "__main__":
    ...
    output_dir = os.path.abspath("./results/darcy/dirichlet")
